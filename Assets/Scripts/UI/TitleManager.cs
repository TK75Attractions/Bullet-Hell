...
public class TitleManager : MonoBehaviour
{
    ...
    private TitleMenuAction[] menuActions = { TitleMenuAction.Start, TitleMenuAction.Transfer };
    ...
    public TitleMenuAction CurrentAction
    {
        get
        {
            if (menuActions == null || menuActions.Length == 0) return TitleMenuAction.Start;
            int index = Mathf.Clamp(menuIndex, 0, menuActions.Length - 1);
    ...
    private void BuildMenu()
    {
        ...
        string[] labels = showOptions
            ? new[] { "スタート", "設定", "引き継ぎ" }
            : new[] { "スタート", "引き継ぎ" };
        menuActions = showOptions
            ? new[] { TitleMenuAction.Start, TitleMenuAction.Options, TitleMenuAction.Transfer }
            : new[] { TitleMenuAction.Start, TitleMenuAction.Transfer };
        float[] rowY = labels.Length == 3
            ? new[] { -178f, -303f, -428f }
            : new[] { -220f, -350f };

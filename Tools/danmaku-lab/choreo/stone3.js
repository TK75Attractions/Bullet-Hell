...
// v33 (背景 CG 組み込み): 導入で 0〜4.1s は空を見上げているため、4.145s に出る詠唱ボスが
//   空に浮いて見える。出現時刻は動かさず、フェードインを 6.6s 完了にして、
//   カメラが通常姿勢へ着地する頃に見えるようにする（6.6 - 4.145404）。
const BOSS_CASTER_FADE_IN = 2.454596;
